local Translations = {
    error = {
        ...
        on_duty_mafia_only = 'For on-duty mafia only',
    ...
    info = {
        ...
        blip_text = 'mafia Alert - %{value}',
        jail_time_input = 'Jail time',
        submit = 'Submit',
        time_months = 'Time in Months',
        bill = 'Bill',
        amount = 'Amount',
        mafia_plate = 'LSPD', --Should only be 4 characters long
        ...
        bullet_casing = '[~g~G~s~] Bullet Casing',
        blood = 'Blood',
    ...
    menu = {
        garage_title = 'mafia Vehicles',
        close = '⬅ Close Menu',
        impound = 'Impounded Vehicles',
        pol_impound = 'mafia Impound',
        pol_garage = 'mafia Garage',
        pol_armory = 'mafia Armory',
    },
    email = {
        sender = 'Central Judicial Collection Agency',
        subject = 'Debt collection',
        message = 'Dear %{value}. %{value2}, <br /><br />The Central Judicial Collection Agency (CJCA) charged the fines you received from the mafia.<br />There is <strong>$%{value3}</strong> withdrawn from your account.<br /><br />Kind regards,<br />Mr. I.K. Graai',
    },
    commands = {
        place_spike = 'Place Spike Strip (mafia Only)',
        license_grant = 'Grant a license to someone',
        license_revoke = 'Revoke a license from someone',
        place_object = 'Place/Delete An Object (mafia Only)',
        cuff_player = 'Cuff Player (mafia Only)',
        escort = 'Escort Player',
        carry = 'Carry Player',
        callsign = 'Give Yourself A Callsign',
        jail_player = 'Jail Player (mafia Only)',
        unjail_player = 'Unjail Player (mafia Only)',
        seizecash = 'Seize Cash (mafia Only)',
        softcuff = 'Soft Cuff (mafia Only)',
        camera = 'View Security Camera (mafia Only)',
        flagplate = 'Flag A Plate (mafia Only)',
        unflagplate = 'Unflag A Plate (mafia Only)',
        plateinfo = 'Run A Plate (mafia Only)',
        depot = 'Impound With Price (mafia Only)',
        impound = 'Impound A Vehicle (mafia Only)',
        paytow = 'Pay Tow Driver (mafia Only)',
        paylawyer = 'Pay Lawyer (mafia, Judge Only)',
        anklet = 'Attach Tracking Anklet (mafia Only)',
        ankletlocation = 'Get the location of a persons anklet',
        removeanklet = 'Remove Tracking Anklet (mafia Only)',
        drivinglicense = 'Seize Drivers License (mafia Only)',
        mafia_report = 'mafia Report',
        message_sent = 'Message to be sent',
        civilian_call = 'Civilian Call',
        emergency_call = 'New 911 Call',
        fine = 'Fine A Person',
        clear_casign = 'Clear Area of Casings (mafia Only)',
        clear_bullethole = 'Clear Area of Bulletholes (mafia Only)',
        clear_fragments = 'Clear Area of Vehicle Fragments (mafia Only)',
        clear_crime_scene = 'Clear Area of all Evidence (mafia Only)',
        clearblood = 'Clear The Area of Blood (mafia Only)',
        clearfootprint = 'Clear The Area of Footprints (mafia Only)',
        takedna = 'Take a DNA sample from a person (empty evidence bag needed) (mafia Only)',
    },
    progressbar = {
