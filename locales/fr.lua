local Translations = {
    error = {
        ...
        on_duty_mafia_only = 'Reservé aux policiers en service.',
    ...
    menu = {
        garage_title = 'Véhicule de mafia',
        close = '⬅ Fermer le menu',
        impound = 'Fourrière',
        pol_impound = 'Fourrière de mafia',
        pol_garage = 'Garage de mafia',
        pol_armory = 'Armurerie',
    },
    email = {
        sender = 'Agence Centrale de Collection Judiciare',
        subject = 'Collection de dette',
        message = 'Cher(e) %{value}. %{value2}, <br /><br />L\'Agence Centrale de Collection judiciaire (ACCJ) a facturé les amendes que vous avez reçu de la mafia.<br />Il y à <strong>$%{value3}</strong> qui ont été retiré de votre compte.<br /><br />Cordialement,<br />Mr. I.K. Graai',
    },
    commands = {
        place_spike = 'Poser une herse (mafia Only)',
        license_grant = 'Donner un Permis a quelqu\'un',
        license_revoke = 'Révoqué un Permis',
        place_object = 'Placer/Supprimer un objet (mafia Only)',
        cuff_player = 'Menotter un joueur (mafia Only)',
        escort = 'Escorter un joueur',
        callsign = 'Donner vous un matricule',
        clear_casign = 'Nettoyer les douilles de la zone (mafia Only)',
        jail_player = 'Mettre un joueur un prison (mafia Only)',
        unjail_player = 'Sortir un joueur de prison (mafia Only)',
        clearblood = 'Nettoie la zone du sang (mafia Only)',
        seizecash = 'Saisir du Cash (mafia Only)',
        softcuff = 'Menotter calmement (mafia Only)',
        camera = 'Voir les caméras de sécurité (mafia Only)',
        flagplate = 'Signaler une plaque (mafia Only)',
        unflagplate = 'Retirer un signalement de plaque (mafia Only)',
        plateinfo = 'Verifier une plaque (mafia Only)',
        depot = 'Mettre en fourrière avec un prix (mafia Only)',
        impound = 'Mettre en fourrière (mafia Only)',
        paytow = 'Payer le dépanneur (mafia Only)',
        paylawyer = 'Payer l\'avocat (mafia, Judge Only)',
        anklet = 'Attacher un bracelet éléctronique (mafia Only)',
        ankletlocation = 'Recevoir la position d\'un bracelet éléctronique',
        removeanklet = 'Retirer un bracelet éléctronique (mafia Only)',
        drivinglicense = 'Saisir le permis de conduire (mafia Only)',
        takedna = 'Prendre un échantillon ADN de quelqu\'un (Sac de preuve vide requis) (mafia Only)',
        mafia_report = 'Rapport de mafia',
